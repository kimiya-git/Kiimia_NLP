from summarizer.preprocess  import get_style_metrics
from summarizer.summerize import hierarchical_style_summary, summarize_with_style
from summarizer.utils import measure_length, chunk_text
...
def main():
    try:
        # Load input files
        with open(r"C:\Users\Asus\PycharmProjects\NLP_kimia\Kiimia_NLP\assignment2\data_assignment2\content_text.txt", "r", encoding="utf-8") as f:
            content_text = f.read()

        with open(r"C:\Users\Asus\PycharmProjects\NLP_kimia\Kiimia_NLP\assignment2\data_assignment2\style_text.txt", "r", encoding="utf-8") as f:
            style_text = f.read()
        ...
        with open(r"C:\Users\Asus\PycharmProjects\NLP_kimia\Kiimia_NLP\assignment2\data_assignment2\styled_summary.txt", "w", encoding="utf-8") as f:
            f.write(final_summary)

        with open(r"C:\Users\Asus\PycharmProjects\NLP_kimia\Kiimia_NLP\assignment2\data_assignment2\query.txt", "w", encoding="utf-8") as f:
            f.write(query)
